...
class IngameSocketEvent implements ShouldBroadcast
{
  ...
  public function broadcastOn()
  {
    ...
    switch ($this->publishType) {
      ...
      case SocketChannelType::PERSONAL_RANK:
        $channelName = $channelName . $this->data['game_id'] . '.' . $this->data['user_id'];
        break;

      case SocketChannelType::PLAYER_CORE_STAT:
        $channelName = $channelName . $this->data['game_id'] . '.' . $this->data['player_id'];
        break;
      ...
      case SocketChannelType::LINEUP_DETAIL:
        ...
        break;
      case SocketChannelType::COMMENTARY:
        $channelName = $channelName . $this->data['schedule_id'];
        break;
