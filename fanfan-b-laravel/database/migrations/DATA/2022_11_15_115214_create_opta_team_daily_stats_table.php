...
return new class extends Migration
{
  public function up()
  {
    Schema::connection('data')->create('opta_team_daily_stats', function (Blueprint $table) {
      $table->id();
      ...
      $table->smallInteger('defender_goals')->default(0);
      ...
      $table->smallInteger('fk_foul_lost')->default(0);
      $table->smallInteger('fk_foul_won')->default(0);
      $table->string('formation_used', 10)->nullable();
      $table->smallInteger('forward_goals')->default(0);
      ...
      $table->smallInteger('midfielder_goals')->default(0);
      ...
      $table->smallInteger('own_goal_accrued')->default(0);
      ...
      $table->smallInteger('pts_dropped_winning_pos')->default(0);
      $table->smallInteger('pts_gained_losing_pos')->default(0);
      ...
      $table->smallInteger('subs_made')->default(0);
      ...
      $table->smallInteger('total_red_card')->default(0);
      ...
      $table->smallInteger('total_yellow_card')->default(0);
      ...
      $table->index(['schedule_id', 'team_id']);
    });
  }

  public function down()
  {
    Schema::connection('data')->dropIfExists('opta_team_daily_stats');
  }
};
